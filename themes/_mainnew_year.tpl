...
<div id="no-ie6">
	...
	<p>Вы используете устаревший браузер Internet Explorer <!--[if IE 6]>6<![endif]--><!--[if IE 7]>7<![endif]-->. Требуется срочное <a href="http://www.microsoft.com/rus/windows/internet-explorer/">обновление</a>.</p>
