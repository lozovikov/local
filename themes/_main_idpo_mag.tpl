...
<head>
	...
	<link rel="stylesheet" href="<?=$EE["http_styles"]?>screen_idpo_mag.css?<?=filemtime($_SERVER['DOCUMENT_ROOT'].$EE['http_styles'].'screen_idpo_mag.css')?>" type="text/css" />
<?php	clearstatcache(); ?>
...
?>		
				...
				<div class="header_title">Профессиональное образование в современном мире</div>
        <?php if ($EE["modules_data"]["right_top"] ) { ?>
        <div id="right_top_menu"><?php $NODEGROUP = "right_top";
			if ($EE["modules_data"][$NODEGROUP])
			    include $EE["theme"] . "_nodegroup" . TEMPLATE_EXT;  ?></div>
          <?php } ?>
...
<?php		$NODEGROUP = "left_submenu";
			if ($EE["modules_data"][$NODEGROUP]) { ?>
						<div class="submenu vertical_menu">
							<div class="corner_TL_">&nbsp;</div>
							<div class="corner_TR_">&nbsp;</div>
							<div class="corner_BL_">&nbsp;</div>
							<div class="corner_BR_">&nbsp;</div>
...
<?php		$NODEGROUP = "footer_block";
			...
			<div id="copyright" style="margin-left: 40px;">
				<p>
