...
if ($Auth->logged_in) {
	...
	content_css: "' . $EE["http_styles"] . 'screen-tinymce.css?1",
		...
		toolbar: " bold italic underline  | alignleft aligncenter alignright alignjustify | styleselect formatselect | bullist numlist | outdent indent | undo redo | link unlink anchor image media code | inserttime preview | table | hr removeformat | subscript superscript | charmap | fullscreen | nonbreaking template ",
		...
		paste_strip_class_attributes : "all",
				...
				template_templates: [
					...
					{title: "Новинка", src: "/themes/template/nova.html", description: "Выделение красным цветом новинки"}
