...
<!--[if lte IE 7]><div id="no-ie6">
	...
	<p>Вы используете устаревший браузер Internet Explorer <![endif]--><!--[if IE 6]>6<![endif]--><!--[if IE 7]>7<![endif]--><!--[if lte IE 7]>. Требуется срочное <a href="http://www.microsoft.com/rus/windows/internet-explorer/" rel="nofollow">обновление</a>.</p>
	<a id="no-ie6_close" href="#" title="Закрыть" rel="nofollow">&times;</a>
</div><![endif]-->
...
left: 47%;
margin-left: -154px;
top: 0px; color: #9c0605; font-weight: bold;">До завершения приёма документов на СПО осталось</div>
...
<!--div class="title" style="position: absolute; bottom: 30px; margin-left: -154px; left: 47%; font-style: italic; font-weight: bold;">
	Продолжается приём документов на <a href="/izop/abiturientam/" style="text-decoration: underline; ">заочное обучение</a></div-->
<div class="title" style="position: absolute;  margin-left: -100px; left: 40%; font-style: italic; font-weight: bold;color:#9c0605;font-size: 20px;top: 45px;text-align: center;">
	День открытых дверей 29 ноября в 11:00,<br/> ул. Добролюбова, 160, актовый зал</div>
				<div id="login_search">
