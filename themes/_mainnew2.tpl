...
<div>
<param name="movie" value="/themes/9_may.swf" style="z-index:-1;"/>

<embed type="application/x-shockwave-flash" wmode="opaque" src="/themes/9_may.swf" width="695" height="150" pluginspage="http://www.macromedia.com/go/getflashplayer" style="z-index:-1;" />
</div>
</object>-->
