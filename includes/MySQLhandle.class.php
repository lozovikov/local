...
// date: 2014-01-13
{
	...
	function AddJoin($joint_field, $field, $join_table = false)
	{
		if(!$join_table) {
			$this->joins[] = array(
			...
			$this->table_joins[$join_table][] = array(
			"joint_field" => $joint_field,
			"field" => $field,
			);
		}
