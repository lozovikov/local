...
fullExpandTitle : 'Расстянуть на полный размер',
restoreTitle : 'Нажмите, чтобы закрыть. Можете перемещать по экрану. Используйте стрелки, чтобы смотреть следующий или предыдущий макет.',
focusTitle : 'Кликните чтобы повернуть лицом',
loadingText : 'Загрузка...',
loadingTitle : 'Кликните чтобы отменить',
loadingOpacity : 0.75,
showCredits : true, // you can set this to false if you want
creditsText : 'Фотограф <i>Александр Гутов</i>',
creditsHref : 'http://agutov.ru/',
creditsTitle : 'Перейти на сайт',
