...
// Filesystem
$moxieManagerConfig['filesystem.rootpath'] = $_SERVER["DOCUMENT_ROOT"]."/images/";  ///webroot/uploads';
...
$moxieManagerConfig['upload.max_width'] = 1000;
$moxieManagerConfig['upload.max_height'] = 1000;
