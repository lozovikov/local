...
?>
	<div class="gallery-item">
		...
		<?php
			...
			{
?>
	<div class="gallery-item"><a href="<?=$data2["output_files"][1]?>" title="<?php echo CF::IsNonEmptyStr($data2["descr"]) ? (htmlspecialchars(strip_tags($data2["descr"])) . ": " . $LANGUAGE["gallery"]["download_descr"]) : $LANGUAGE["gallery"]["download_descr2"]; ?> (<?php echo CF::FormatFilesize($data["filesize"], $LANGUAGE["gallery"]["filesize"]); ?>)"><img src="<?=$data2["output_files"][2]?>" alt="<?php echo CF::IsNonEmptyStr($data["descr"]) ? (htmlspecialchars(strip_tags($data["descr"])) . ": " . $LANGUAGE["gallery"]["enlarge_descr"]) : $LANGUAGE["gallery"]["enlarge_descr2"]; ?> (<?php echo CF::FormatFilesize($data["filesize"], $LANGUAGE["gallery"]["filesize"]); ?>)" /></a><div class="pusher"></div><?php
			}
